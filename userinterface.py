...
class Ui_resultsWindow(object):
	def setupUi(self, resultsWindow, results, product):
		...
		self.productLabel.setGeometry(QRect(80, 40, 200, 35))
		font = QFont()
		font.setPointSize(24)
		font.setBold(True)
		font.setWeight(75)
	...
	def retranslateUi(self, resultsWindow):
		...
		self.titleLabel.setText(_translate("resultsWindow", "Recommendations", None))
...
class Ui_selectionWindow(object):
    def setupUi(self, selectionWindow):
        ...
        self.uploadImageButton.setGeometry(QRect(260, 420, 150, 30))
        ...
        self.textureSlider.setMinimum(0)
        self.textureSlider.setMaximum(10)
        ...
        self.shapeSlider.setMinimum(0)
        self.shapeSlider.setMaximum(10)
        ...
        self.titleLabel = QLabel(self.centralWidget)
        self.titleLabel.setGeometry(QRect(130, 10, 550, 55))
        font = QFont()
        font.setPointSize(24)
        font.setBold(True)
        font.setWeight(75)
